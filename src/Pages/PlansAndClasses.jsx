    ...
    <div className="bg-[#F1F5F9] h-screen w-full flex flex-col p-8">
      ...
      <div className="flex flex-row mt-10 ml-4 space-x-8">
        ...
        <div className="bg-[#F8FAFC] h-[736px] w-[2000px] flex flex-col ml-[160px]  rounded-3xl">
            <h1 className="mt-8 ml-8">Plans</h1>
           
          <div className="flex ">
          <div className="bg-gradient-to-r from-[#4C1D95] to-[#C4B5FD] h-[196px] w-[337px] flex ml-[100px] mt-10 rounded-[35px] justify-center items-center">
           <img src={Logo}></img>
           <div className="flex flex-col">
            <h1>Member</h1>
            <h1>200 LKR</h1>
            ...
            <div className="bg-gradient-to-r from-[#4C1D95] to-[#C4B5FD] h-[196px] w-[337px] flex flex-col ml-[100px] mt-10 rounded-[35px] justify-center items-center">
