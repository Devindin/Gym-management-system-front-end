...
function InputField({label ,name,type,placeholder, handleChange , values}) {
  return (
    <div className="form-field-container flex flex-col sm:mt-5 w-full space-y-2">
      ...
      <div className="form-field-input-container w-[400px] rounded-[6px] bg-[#ffffff] h-[38px] border-[1px] border-[#565656] border-opacity-20 flex flex-row justify-center items-center">
        <Field
          type={type}
          name={name}
          value ={values[name]}
