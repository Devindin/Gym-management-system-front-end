...
function InputPassword({
  ...
  return (
    <div className="form-field-container flex flex-col sm:mt-5 w-[400px] space-y-2">
      <div className="form-field-lable sm:flex justify-between w-full hidden">
        <span className="text-white text-[12px] uppercase font-semibold">
          {label}
        </span>
        <ErrorMessage
          name={name}
      ...
      <div className="form-field-input-container w-full rounded-[6px] bg-[#ffffff] h-[38px] border-[1px] border-[#565656] border-opacity-20 flex flex-row justify-center items-center">
        <div className="form-field-input-icobox bg-[#A5B4FC] h-[38px] w-[38px] rounded-bl-[6px] rounded-tl-[6px] justify-center items-center flex">
        ...
        <div className="h-[38px] w-[38px] rounded-tl-[6px] rounded-bl-[6px] justify-center items-center flex">
          {passwordVisible ? (
            <span
              className="text-[16px] text-[#A5B4FC] cursor-pointer"
